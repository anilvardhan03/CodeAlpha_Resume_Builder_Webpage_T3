...
function downloadResume() {
    ...
    const downloadPath = prompt("Please enter the download path for your resume:", "G Naga Mouli Anil Resume .pdf");
    if (downloadPath) {
      const opt = {
        margin: 10,
  ...
  // Function to update the resume content based on user input
  function updateResume() {
    // Your existing updateResume function code here
  }
